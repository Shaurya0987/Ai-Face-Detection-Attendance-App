    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          RecentActivityContainer(title: "Physics Lab", subtitle: "Marked Present Face Scan", time: "2:00 PM", day: "YESTERDAY", icon: Icons.check_circle, iconColor: Colors.green.shade200, colorShade: Colors.green.shade100),
